...
winpty ng.cmd new --create-application=false WORKSPACE_NAME
cd WORKSPACE_NAME
...
###################################################
winpty ng.cmd g application --inline-style --inline-template --routing --style=scss APP_NAME
...
winpty ng.cmd g library @c4-soft/API_LIB_NAME
...
$SED 's/"entryFile": "src\/public-api.ts"/"entryFile": "index.ts"/' ./projects/c4-soft/API_LIB_NAME/ng-package.json
...
$SED 's/"$schema": ".\/node_modules\/ng-packagr\/ng-package.schema.json"/"$schema": ".\/node_modules\/ng-packagr\/ng-package.schema.json",\
...
$SED 's/"projects\/APP_NAME\/src\/assets"/"projects\/APP_NAME\/src\/assets",\
...
$SED 's/BrowserModule,/BrowserModule,\
    HttpClientModule,\
    IonicModule.forRoot(),\
...
$SED 's/"test": "echo \\"Error: no test specified\\" \&\& exit 1"/"test": "ionic test",\
    "build": "ionic build",\
    "serve": "ionic serve",\
    "android": "ionic capacitor run android -l"/' ./projects/APP_NAME/package.json

$SED 's/"start": "ng serve"/"APP_NAME:serve": "cd projects\/APP_NAME \&\& npm run serve",\
    "APP_NAME:android": "cd projects\/APP_NAME \&\& npm run android"/' ./package.json
$SED 's/"build": "ng build"/"APP_NAME:build": "cd projects\/APP_NAME \&\& npm run build"/' ./package.json
$SED 's/"test": "ng test"/"APP_NAME:test": "cd projects\/APP_NAME \&\& npm run test"/' ./package.json
$SED '/"watch":/d' ./package.json
...
$SED 's/CommonModule,/CommonModule,\
    FormsModule,\
    ReactiveFormsModule,\
    IonicModule,/' ./projects/APP_NAME/src/app/settings/settings.module.ts
winpty ng.cmd g c --project=APP_NAME --type=screen --flat -s -t -m=settings settings/Settings
...
winpty ng.cmd g module --project=APP_NAME --routing user-account
echo -e "import { FormsModule, ReactiveFormsModule } from '@angular/forms';\n\
import { IonicModule } from '@ionic/angular';\n\
...
winpty ng.cmd g c --project=APP_NAME --type=screen --flat -s -t -m=user-account user-account/UserAccount
...
cd ../../../../
$SED 's/\/node_modules/**\/node_modules/' ./.gitignore
